...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderOptions.base_folder'
        db.add_column('cmsplugin_slideroptions', 'base_folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliderOptions.base_folder'
        db.delete_column('cmsplugin_slideroptions', 'base_folder_id')
