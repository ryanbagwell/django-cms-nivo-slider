...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SliderOptions.selected_images'
        db.add_column('cmsplugin_slideroptions', 'selected_images', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SliderOptions.selected_images'
        db.delete_column('cmsplugin_slideroptions', 'selected_images')
    ...
    models = {
        ...
        'slider.slideroptions': {
            ...
            'selected_images': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
