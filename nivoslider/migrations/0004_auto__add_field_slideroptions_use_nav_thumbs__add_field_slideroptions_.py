...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderOptions.use_nav_thumbs'
        db.add_column('cmsplugin_slideroptions', 'use_nav_thumbs',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SliderOptions.direction_nav'
        db.add_column('cmsplugin_slideroptions', 'direction_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliderOptions.use_nav_thumbs'
        db.delete_column('cmsplugin_slideroptions', 'use_nav_thumbs')

        # Deleting field 'SliderOptions.direction_nav'
        db.delete_column('cmsplugin_slideroptions', 'direction_nav')
