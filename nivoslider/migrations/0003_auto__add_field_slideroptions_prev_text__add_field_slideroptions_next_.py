...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliderOptions.prev_text'
        db.add_column('cmsplugin_slideroptions', 'prev_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SliderOptions.next_text'
        db.add_column('cmsplugin_slideroptions', 'next_text',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliderOptions.prev_text'
        db.delete_column('cmsplugin_slideroptions', 'prev_text')

        # Deleting field 'SliderOptions.next_text'
        db.delete_column('cmsplugin_slideroptions', 'next_text')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'nivoslider.slideroptions': {
            ...
            'base_folder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Folder']", 'null': 'True', 'blank': 'True'}),
            ...
            'next_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'prev_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
